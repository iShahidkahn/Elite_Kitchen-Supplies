...
const WhyUs = () => {
    return (
        <>
            <div className='why-us mx-5 sm:mx-5 md:mx-20 lg:mx-32 my-10'>
                ...
                <div className="sm:grid grid-cols-5">
                    ...
                    <div className="col-span-2 sm:flex sm:justify-end">
                        <Image src="/images/about_us.svg" width={10} height={0} alt='image' className='sm:w-80 w-full my-3 sm:my-0' />
                    </div>
                </div>
            </div>
            ...
            <div className='mx-5 sm:mx-10 lg:mx-20 lg:mx-20 border p-8 rounded'>
                <div className="md:grid grid-cols-4">
                    ...
                    <div className="col-span-2 border mx-1 sm:hidden">
                        <div className='my-5'>
                            <h1 className='text-lg font-medium uppercase'>TIMING:</h1>
                            <div className="border w-3/4 md:w-2/3">
                    ...
                    <div className="col-span-2 border mx-1 hidden sm:block">
                        <div className='my-5'>
                            <h1 className='text-lg font-medium uppercase'>TIMING:</h1>
                            <div className="border w-3/4 md:w-2/3">
                                <div className="flex justify-between">
